...
public class EditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Emp e = EmpDataAccess.getEmployeeById(id);
		pw.print("<form action='EditServlet2' method='post'>");
		
		pw.print("<table>");
		pw.print("<tr> <td>ID: </td> <td><input type='hidden' name='id' value='"+e.getId()+"'></td></tr>");
		pw.print("<tr><td>Name: </td> <td><input type='text' name='username' value='"+e.getName()+"'></td></tr>");
		...
		pw.print("<select name='country' style='width:100px'>");
